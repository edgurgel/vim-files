return {
  ...
  keys = {
    { '<leader>tr', "<cmd>:w<cr><cmd>lua require('neotest').run.run()<CR>",                   remap = false, desc = "Run nearby test" },
    { '<leader>ts', "<cmd>lua require('neotest').run.run({ suite = true })<CR>",              remap = false, desc = "Run test suite" },
    { '<leader>tf', "<cmd>:w<cr><cmd>lua require('neotest').run.run(vim.fn.expand('%'))<CR>", remap = false, desc = "Run test file" },
    ...
    { '<leader>tt', "<cmd>lua require('neotest').summary.toggle()<CR>",                       remap = false, desc = "Tests Summary" },
